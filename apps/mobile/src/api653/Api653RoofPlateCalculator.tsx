...
export function Api653RoofPlateCalculator({ onBack }: { onBack: () => void }) {
  ...
  const [fields, setFields] = useState<RoofFields>({
    ...
    minimumThickness: { value: "2.29", unit: "mm", quantity: "length" },
  });
  ...
  const reset = () => {
    setUnitSystem("metric"); setBuildYear("2006"); setPreviousInspectionYear("2021"); setServiceYearsMode("auto"); setInspectionYearsMode("auto"); setManualServiceYears("20"); setManualInspectionYears("5");
    setFields({ originalThickness: { value: "6", unit: "mm", quantity: "length" }, previousThickness: { value: "5.5", unit: "mm", quantity: "length" }, actualThickness: { value: "5", unit: "mm", quantity: "length" }, minimumThickness: { value: "2.29", unit: "mm", quantity: "length" } });
  };
  ...
  return <div className="calculator-page api653-roof-page">
    ...
    <div className="calculator-workspace"><div className="input-column">
      <section className="form-card"><div className="form-card-heading"><div><span>01</span><div><h2>Calculation basis</h2><p>Set the project minimum and choose the result unit system.</p></div></div><Wrench size={19} /></div><div className="form-grid">
        ...
        <UnitInput label="Minimum required thickness" field={fields.minimumThickness} options={lengthUnits} help="The protected source starts at 2.29 mm. Confirm the applicable controlled project minimum before use." onValueChange={(value) => updateFieldValue("minimumThickness", value)} onUnitChange={(unit) => updateFieldUnit("minimumThickness", unit)} />
